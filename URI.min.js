...
g[h].split(""),t=0;3>t;t++)if("0"===f[0]&&1<f.length)f.splice(0,1);else break;g[h]=f.join("")}var f=-1,p=t=0,s=-1,r=!1;for(h=0;h<b;h++)r?"0"===g[h]?p+=1:(r=!1,p>t&&(f=s,t=p)):"0"==g[h]&&(r=!0,s=h,p=1);p>t&&(f=s,t=p);1<t&&g.splice(f,t,"");f=g.length;b="";""===g[0]&&(beststr=":");for(h=0;h<f;h++){b+=g[h];if(h===f-1)break;b+=":"}""===g[f-1]&&(b+=":");return b},noConflict:function(){f.IPv6===this&&(f.IPv6=h);return this}}});(function(f){function h(a){throw RangeError(d[a]);}function g(a,c){for(var d=a.length;d--;)a[d]=c(a[d]);return a}function n(a){for(var c=[],d=0,b=a.length,m,e;d<b;)m=a.charCodeAt(d++),55296<=m&&56319>=m&&d<b?(e=a.charCodeAt(d++),56320==(e&64512)?c.push(((m&1023)<<10)+(e&1023)+65536):(c.push(m),d--)):c.push(m);return c}function b(a){return g(a,function(a){var c="";65535<a&&(a-=65536,c+=A(a>>>10&1023|55296),a=56320|a&1023);return c+=A(a)}).join("")}function z(a,c,d){var b=0;a=d?B(a/y):a>>1;for(a+=B(a/
